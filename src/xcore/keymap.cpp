...
//	{"keyname",xkeyid,"zxkeys","profiextkeys","msxkeys",{cpmcode,rowscan}(atm),ps2code(set3),atcode(set2),xtcode(set1),joybind}
static keyEntry keyMapInit[] = {
	...
	{"6",XKEY_6,{'6',0},{0,0},{'6',0},{'6',0x45},0x36,0x36,0x07,0x06,0},
	{"7",XKEY_7,{'7',0},{0,0},{'7',0},{'7',0x44},0x3d,0x3d,0x08,0x07,0},
	{"8",XKEY_8,{'8',0},{0,0},{'8',0},{'8',0x43},0x3e,0x3e,0x09,0x08,0},
	{"9",XKEY_9,{'9',0},{0,0},{'9',0},{'9',0x42},0x46,0x46,0x0a,0x09,0},
	{"0",XKEY_0,{'0',0},{0,0},{'0',0},{'0',0x41},0x45,0x45,0x0b,0x0a,0},
	...
	{"LS",XKEY_LSHIFT,{'C',0},{0,0},{MSXK_SHIFT,0},{0,0x08},0x12,0x12,0x2a,0x70,0},
	...
	{"LC",XKEY_LCTRL,{'S',0},{0,0},{MSXK_CTRL,0},{0,0x80},0x11,0x14,0x1d,0x74,0},		// TODO
	{"SPC",XKEY_SPACE,{' ',0},{0,0},{' ',0},{0x20,0x71},0x29,0x29,0x39,0x34,0},

	{"RS",XKEY_RSHIFT,{0,0},{0,0},{0,0},{0,0},0x59,0x59,0x36,0x7d,0},
	{"RC",XKEY_RCTRL,{0,0},{0,0},{0,0},{0,0},0x58,0x14e0,0x1de0,0x00,0},
	...
	{"CAPS",XKEY_CAPS,{'C','2'},{'C','2'},{MSXK_CAP,0},{0,0x3a},0x14,0x58,0x3a,0x71,0},
	...
	{"\\",XKEY_SLASH,{'S','C'},{0,0},{'\\',0},{0x2f,0x92},0x5c,0x5d,0x2b,0x28,0},		// TODO
	...
	{";",XKEY_DOTCOM,{'S','o'},{'S','o'},{';',0},{0x3b,0xd2},0x4c,0x4c,0x27,0x26,0},
	{"\"",XKEY_APOS,{'S','p'},{'S','p'},{0X27,0},{0x27,0xd1},0x52,0x52,0x28,0x27,0},		// '
	{"-",XKEY_MINUS,{'S','j'},{'S','j'},{'-',0},{0x2d,0xe4},0x4e,0x4e,0x0c,0x0b,0},
	{"+",XKEY_EQUAL,{'S','k'},{'S','k'},{'+',0},{0x3d,0xe2},0x44,0x44,0x0d,0x0c,0},		// NOTE
	{",",XKEY_COMMA,{'S','n'},{'S','n'},{',',0},{0x2c,0xf4},0x41,0x41,0x33,0x30,0},
	{".",XKEY_PERIOD,{'S','m'},{'S','m'},{'.',0},{0x2e,0xf3},0x49,0x49,0x34,0x31,0},
	{"/",XKEY_BSLASH,{'S','c'},{'S','c'},{'/',0},{0x5c,0x85},0x4a,0x4a,0x35,0x32,0},
	...
	{"LA",XKEY_LALT,{0,0},{0,0},{0,0},{0,0},0x19,0x11,0x38,0x00,0},
	{"RA",XKEY_RALT,{0,0},{0,0},{MSXK_GRAPH,0},{0,0},0x39,0x11e0,0x38e0,0x72,0},		// nec: kana key
