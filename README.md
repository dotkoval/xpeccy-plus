...
Current version: **2026.1**. Forked from upstream build `20260807`.
...
machine profiles, macOS builds, eight interface styles, a debugger with movable panels, a
memory heat map and AF/AF' in it, a working ZX Evo (TSConf), and tape loading fixes.
...
the version in brackets in the window title - `Xpeccy+ (2026.1-dev+20260807)`, against
`Xpeccy+ (2026.1)` for a release build.
